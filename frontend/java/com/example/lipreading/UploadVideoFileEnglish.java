...
public class UploadVideoFileEnglish implements Callable<String> {
    Uri videoUri;
    static final String TAG = "MainActivity";
    ContentResolver contentResolver;
    public  UploadVideoFileEnglish(Uri videoUri, ContentResolver contentResolver){
    ...
    public String call() throws Exception {
        ...
        String url = ColabLink.url+"/upload";
